...
def getExecPlfDir(args=None, config=BuildConfig.AUTO):
  ...
  Examples:
    >>> getExecPlfDir()
    Windows: 'C:\\Program Files\\OpendTect\\7.0.0\\bin\\win64\\Release'
    Linux: '/home/user/OpendTect/7.0.0/bin/lux64/Release'
    MacOS: '/Applications/OpendTect/OpendTect 7.0.0.app/Contents/MacOS'
...
def getLibPlfDir(args=None, config=BuildConfig.AUTO):
  ...
  Examples:
    ...
    Windows: 'C:\\Program Files\\OpendTect\\7.0.0\\bin\\win64\\Release'
    Linux: '/home/user/OpendTect/7.0.0/bin/lux64/Release'
    MacOS: '/Applications/OpendTect/OpendTect 7.0.0.app/Contents/Frameworks'
